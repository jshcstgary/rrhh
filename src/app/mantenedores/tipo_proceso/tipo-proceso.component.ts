...
export class TipoProcesoComponent implements OnInit {
  ...
  public tableInputsEditRow: IInputsComponent = TipoprocesoData.tableInputsEditRow;
  public colsToFilterByText: string[] = TipoprocesoData.colsToFilterByText;
  public IdRowToClone: string = null;
  public defaultEmptyRowTable: ITipoprocesoTable = TipoprocesoData.defaultEmptyRowTable;
  public dataTipoSolicitudes: any[] = [];
  public codigoReporte: reportCodeEnum = reportCodeEnum.MANTENIMIENTO_TIPO_PROCESO;
  constructor(
