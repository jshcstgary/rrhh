...
import { ITipoSolcitud, ITipoaccion, ITipoaccionTable } from './tipo-accion.interface';
...
export class TipoAccionComponent implements OnInit {
  ...
  public tableInputsEditRow: IInputsComponent = TipoaccionData.tableInputsEditRow;
  public colsToFilterByText: string[] = TipoaccionData.colsToFilterByText;
  public IdRowToClone: string = null;
  public defaultEmptyRowTable: ITipoaccionTable = TipoaccionData.defaultEmptyRowTable;
  ...
  private formatTipoSolicitudEstaciones(accionResponse:ITipoaccion):string{
    const tipoSolcicitud=this.dataTipoSolicitudes.find(tipoSolcicitud=>tipoSolcicitud.id==accionResponse.tipoSolicitudId);
    if(tipoSolcicitud){
