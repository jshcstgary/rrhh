...
@Component({
  ...
  imports: [
    ...
    NgFor,
    CommonModule],
  templateUrl: './consulta-tarea.component.html',
  styleUrls: ['./consulta-tarea.css']
})
export class ConsultaTareaComponent implements OnInit {
  ...
  @ViewChild(ConsultaTareaComponent) table: ConsultaTareaComponent | any;
