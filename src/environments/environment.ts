...
export const environment = {
  ...
  exempleadoService: `${baseRBP}:8289/v1/us/exempleados_rbp`,
  ...
  //perfilUsuarioES: `${base}:8308/api/us/integracion-seguridad/perfil-usuario`,
  //perfilUsuarioES: `${baseRBP}:8092/api/us/integracion-seguridad/perfil-usuario`,
  perfilUsuarioES: `${baseRBP}:8292/api/us/integracion-seguridad/perfil-usuario`,
  /*
