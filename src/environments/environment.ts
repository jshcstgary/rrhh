...
const baseRBP = "http://10.35.3.162"; //base de servicios local
const base = "http://192.168.44.180"; //base de servicios RBP
...
export const environment = {
	...
	reporteUS: `http://10.35.3.162:8091/v1/us/reporte`,
	// reporteUS: `${baseG}/v1/us/reporte`,
	//reporteUS: `${baseRBP}:50063/v1/us/reporte`,
	...
	exempleadoServiceEsJaff: `${baseRBP}:8076/v1/us/exempleadojaff`,
	...
	tipoSolicitudServiceES: `${baseRBP}:8068/v1/es/tiposolicitud`,
	...
	tipoMotivoServiceES: `${baseRBP}:8072/v1/es/tipomotivo`, //10.35.3.162:8072/v1/es/tipomotivo

	// accionServiceES: `${base}:8073/v1/es/accion`,
	// accionServiceES: `${baseG}/v1/es/accion`,
	accionServiceES: `${baseRBP}:8073/v1/es/accion`,
	...
	tipoAccionServiceES: `${baseRBP}:8074/v1/es/tipoaccion`, //10.35.3.162:8074/v1/es/tipoaccion

	// CatalogoServiceES: `${base}:8065/v1/es/item-catalogo`,
	// CatalogoServiceES: `${baseG}/v1/es/item-catalogo`,
	CatalogoServiceES: `${baseRBP}:8065/v1/es/item-catalogo`,
	...
	nivelAprobacionServiceES: `${baseRBP}:8067/v1/es/nivelesaprobacion`, //http://10.35.3.162:8000/v1/es/nivelesaprobacion

	// empleadoServiceEs: `${base}:8078/v1/us/empleadoev`,
	// empleadoServiceEs: `${baseG}/v1/us/empleadoev`,
	empleadoServiceEs: `${baseRBP}:8078/v1/us/empleadoev`,
	...
	nivelAprobacionRefreshServiceES: `${baseRBP}:8075/v1/es/refresh_nivelesAprobacion`,
	...
	solicitudesServiceES: `${baseRBP}:8066/v1/es/solicitud`, // http://10.35.3.162:8066/v1/es/solicitud

	// tareasServiceES: `${base}:8080/v1/es/solicitudcamunda`,
	// tareasServiceES: `${baseG}/v1/es/solicitudcamunda`,
	tareasServiceES: `${baseRBP}:8080/v1/es/solicitudcamunda`,

	// aprobadoresFijosServiceES: `${base}:8080/v1/es/aprobadores_fijos`,
	// aprobadoresFijosServiceES: `${baseG}/v1/es/aprobadores_fijos`,
	aprobadoresFijosServiceES: `${baseRBP}:8082/v1/es/aprobadores_fijos`,

	// historicaCamundaServiceEs: `${base}:8077/v1/es/historicacamunda`,
	// historicaCamundaServiceEs: `${baseG}/v1/es/historicacamunda`,
	historicaCamundaServiceEs: `${baseRBP}:8077/v1/es/historicacamunda`,
	...
	detalleAprobacionesServiceES: `${baseRBP}:8083/v1/es/detalles_aprobaciones_solicitudes`,
	...
	senEmailService: `${baseRBP}:8085/v1/es/mail`,

	// comentarioServiceES: `${base}:8088/v1/es/comentarios`,
	// comentarioServiceES: `${baseG}/v1/es/comentarios`,
	comentarioServiceES: `${baseRBP}:8088/v1/es/comentarios`,

	loginES: `${baseRBP}:8308/api/us/integracion-seguridad/iguana/obtenercredenciales`,
	// loginES: `${baseG}/api/us/integracion-seguridad`,
	//loginES: `${baseRBP}:8092/api/us/integracion-seguridad/obtenercredenciales`,

	perfilUsuarioES: `${baseRBP}:8308/api/us/integracion-seguridad/perfil-usuario`,
  	//perfilUsuarioES: `${baseRBP}:8092/api/us/integracion-seguridad/perfil-usuario`,
  	//perfilUsuarioES: `${baseRBP}:8092/api/us/integracion-seguridad/perfil-usuario`,
